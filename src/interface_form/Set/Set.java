...
public interface Set<E> {
     ...
     * @param e 집합에 추가할 요소
     * @return {@code true} 만약 Set에 지정 요소가 포함되지 않아 정상적으로 추가되었을 경우, else, {@code false}
     */
    boolean add(E e);
     ...
     * @return {@code true} 만약 Set에 지정 요소가 포함되어 정상적으로 삭제되었을 경우, else, {@code false}
     */
     ...
     * @return {@code true} Set에 지정 요소가 포함되어 있을 경우, else, {@code false}
     */
     ...
     * @param o 집합과 비교할 객체
     * @return {@code true} 비교할 집합과 동일한 경우, else, {@code false}
     */
    boolean equals(Object o);

    /**
     * 현재 집합이 빈 상태(요소가 없는 상태)인지 여부를 반환합니다.
     * @return {@code true} 집합이 비어있는 경우, else, {@code false}
     */
    boolean isEmpty();
